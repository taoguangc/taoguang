...
export default function hero() {
  return (
    <>
      ...
      {/* <section className="relative mx-auto flex max-w-[1280px] flex-col gap-8 md:h-72 md:flex-row xl:h-96">
        <div className="md:w-1/2 lg:w-2/5">
          <p className="pl-0 leading-relaxed text-neutral-500 lg:pl-20">
        ...
        <div className="md:w-1/2 lg:w-3/5">
          <div className="md:h-72 lg:-mr-[calc(-50%+512px)] xl:h-96">
            <Image src={Hero} width={960} alt="Hero" className="h-full w-full object-cover object-center" priority />
          </div>
        </div>
      </section> */}
